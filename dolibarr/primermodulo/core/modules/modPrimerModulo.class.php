 ...
 */
class modPrimermodulo extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'primermodulo';
		...
		$this->dirs = array("/primermodulo/temp");
	...
	$this->tabs = array('objecttype:+tabname1:Title1:@primermodulo:/primermodulo/mynewtab1.php',  // To add a new tab identified by code tabname1
	'objecttype:+tabname2:Title2:@primermodulo:/primermodulo/mynewtab2.php',  // To add another new tab identified by code tabname2
	'objecttype:-tabname');                                                     // To remove an existing tab identified by code tabname
		...
		*/
		...
		$this->menu[$r++] = array(
			...
			'mainmenu'=>'primermodulo',
			'leftmenu'=>'',
			'url'=>'/primermodulo/index.php',
			'langs'=>'primermodulo@primermodulo', // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000 + $r,
			'enabled'=>'$conf->primermodulo->enabled', // Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
	...
	public function init($options = '')
	{
		...
		$result = $this->_load_tables('/primermodulo/sql/');
		if ($result < 0) {
