...
$hookmanager->initHooks(array('ecommercesetup', 'globalsetup'));
...
$arrayofparameters = array(
	'ECOMMERCE_MYPARAM1'=>array('type'=>'string', 'css'=>'minwidth500' ,'enabled'=>1),
	'ECOMMERCE_MYPARAM2'=>array('type'=>'textarea','enabled'=>1),
	//'ECOMMERCE_MYPARAM3'=>array('type'=>'category:'.Categorie::TYPE_CUSTOMER, 'enabled'=>1),
	//'ECOMMERCE_MYPARAM4'=>array('type'=>'emailtemplate:thirdparty', 'enabled'=>1),
	//'ECOMMERCE_MYPARAM5'=>array('type'=>'yesno', 'enabled'=>1),
	//'ECOMMERCE_MYPARAM5'=>array('type'=>'thirdparty_type', 'enabled'=>1),
	//'ECOMMERCE_MYPARAM6'=>array('type'=>'securekey', 'enabled'=>1),
	//'ECOMMERCE_MYPARAM7'=>array('type'=>'product', 'enabled'=>1),
);
...
if ($useFormSetup && (float) DOL_VERSION >= 15) {
	...
	// Setup conf ECOMMERCE_MYPARAM1 as a simple string input
	$item = $formSetup->newItem('ECOMMERCE_MYPARAM1');

	// Setup conf ECOMMERCE_MYPARAM1 as a simple textarea input but we replace the text of field title
	$item = $formSetup->newItem('ECOMMERCE_MYPARAM2');
	$item->nameText = $item->getNameText().' more html text ';

	// Setup conf ECOMMERCE_MYPARAM3
	$item = $formSetup->newItem('ECOMMERCE_MYPARAM3');
	$item->setAsThirdpartyType();

	// Setup conf ECOMMERCE_MYPARAM4 : exemple of quick define write style
	$formSetup->newItem('ECOMMERCE_MYPARAM4')->setAsYesNo();

	// Setup conf ECOMMERCE_MYPARAM5
	$formSetup->newItem('ECOMMERCE_MYPARAM5')->setAsEmailTemplate('thirdparty');

	// Setup conf ECOMMERCE_MYPARAM6
	$formSetup->newItem('ECOMMERCE_MYPARAM6')->setAsSecureKey()->enabled = 0; // disabled

	// Setup conf ECOMMERCE_MYPARAM7
	$formSetup->newItem('ECOMMERCE_MYPARAM7')->setAsProduct();
	*/
...
print dol_get_fiche_head($head, 'settings', $langs->trans($page_name), -1, "ecommerce@ecommerce");
