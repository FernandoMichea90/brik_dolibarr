...
/**
 * \file    test/phpunit/EcommerceFunctionalTest.php
 * \ingroup ecommerce
 ...
 */
class EcommerceFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEcommerce')->click();
		} else {
			// Disable the module
			$this->byHref('modEcommerce')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/ecommerce/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('ecommerce/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/ecommerce/admin/about.php');
		$this->authenticate();
		return $this->assertContains('ecommerce/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('ecommercewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEcommerce_EcommerceTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEcommerce_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
