...
/**
 *  \file       core/modules/ecommerce/doc/pdf_standard.modules.php
 *  \ingroup    ecommerce
...
/**
 *	Class to manage PDF template standard_producto
 */
class pdf_standard_producto extends ModelePDFProducto
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_PRODUCTO_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->ecommerce->dir_output.'/producto') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->ecommerce->dir_output.'/producto';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->ecommerce->dir_output.'/producto/'.$objectref;
