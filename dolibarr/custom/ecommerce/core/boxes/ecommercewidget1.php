...
/**
 * \file    ecommerce/core/boxes/ecommercewidget1.php
 * \ingroup ecommerce
 * \brief   Widget provided by Ecommerce
 *
 ...
 */
class ecommercewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "ecommercebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "ecommerce@ecommerce";
	 ...
	 */
	public $depends = array('ecommerce');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "ecommerce@ecommerce"));
		...
		//$this->hidden = ! ($user->rights->ecommerce->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/ecommerce/class/ecommerce.class.php");

		// Populate the head at runtime
		$text = $langs->trans("EcommerceBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_ecommerce@ecommerce',
