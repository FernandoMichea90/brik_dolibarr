...
ALTER TABLE llx_marca_marca ADD INDEX idx_marca_marca_fk_soc (fk_soc);
ALTER TABLE llx_marca_marca ADD INDEX idx_marca_marca_fk_project (fk_project);
...
ALTER TABLE llx_marca_marca ADD INDEX idx_marca_marca_status (status);
