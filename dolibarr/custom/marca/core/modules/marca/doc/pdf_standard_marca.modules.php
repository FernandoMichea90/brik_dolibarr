...
/**
 *  \file       core/modules/marca/doc/pdf_standard.modules.php
 *  \ingroup    marca
...
/**
 *	Class to manage PDF template standard_marca
 */
class pdf_standard_marca extends ModelePDFMarca
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_MARCA_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->marca->dir_output.'/marca') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->marca->dir_output.'/marca';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->marca->dir_output.'/marca/'.$objectref;
