...
/**
 * \file    test/phpunit/MarcaFunctionalTest.php
 * \ingroup marca
 ...
 * @package Testmarca
 */
class MarcaFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/marca/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('marca/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/marca/admin/about.php');
		$this->authenticate();
		return $this->assertContains('marca/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('marcawidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMarca_MarcaTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMarca_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
