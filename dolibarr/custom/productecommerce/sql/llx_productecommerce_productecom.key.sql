...
--ALTER TABLE llx_productecommerce_productecom ADD CONSTRAINT llx_productecommerce_productecom_fk_field FOREIGN KEY (fk_field) REFERENCES llx_productecommerce_myotherobject(rowid);
