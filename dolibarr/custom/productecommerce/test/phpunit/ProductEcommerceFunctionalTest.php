...
/**
 * \file    test/phpunit/ProductEcommerceFunctionalTest.php
...
/**
 * Class ProductEcommerceFunctionalTest
 *
 ...
 *
 * @package Testproductecommerce
 */
class ProductEcommerceFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modProductEcommerce')->click();
		} else {
			// Disable the module
			$this->byHref('modProductEcommerce')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/productecommerce/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('productecommerce/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/productecommerce/admin/about.php');
		$this->authenticate();
		return $this->assertContains('productecommerce/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('productecommercewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modProductEcommerce_ProductEcommerceTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProductEcommerce_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
