...
/**
 *	\file       productecommerce/productecommerceindex.php
 *	\ingroup    productecommerce
 *	\brief      Home page of productecommerce top menu
 */
...
llxHeader("", $langs->trans("ProductEcommerceArea"));
...
if (! empty($conf->productecommerce->enabled) && $user->rights->productecommerce->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."productecommerce_myobject as s";
	//if (! $user->rights->societe->client->voir && ! $socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
