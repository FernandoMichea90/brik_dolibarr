...
/**
 * \file    sii/core/boxes/siiwidget1.php
 * \ingroup sii
 * \brief   Widget provided by Sii
 *
 ...
 */
class siiwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "siibox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "sii@sii";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "sii@sii"));
		...
		//$this->hidden = ! ($user->rights->sii->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/sii/class/sii.class.php");

		// Populate the head at runtime
		$text = $langs->trans("SiiBoxDescription", $max);
