...
/**
 * \file    test/phpunit/SiiFunctionalTest.php
 * \ingroup sii
 ...
 * @package Testsii
 */
class SiiFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/sii/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('sii/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/sii/admin/about.php');
		$this->authenticate();
		return $this->assertContains('sii/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('siiwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSii_SiiTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSii_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
