...
function top_menu($head, $title = '', $target = '', $disablejs = 0, $disablehead = 0, $arrayofjs = '', $arrayofcss = '', $morequerystring = '', $helppagename = '')
{
	...
	if ((empty($conf->dol_hide_topmenu) || GETPOST('dol_invisible_topmenu', 'int')) && (!defined('NOREQUIREMENU') || !constant('NOREQUIREMENU'))) {
		...
		print ' <!--final::Menu-->';
		print "</div>\n";
		print ' <!--final::MenuWrapper-->';
		print "</div>\n";
		print ' <!--final::Navbar-->';
		toolBar();
		print "</div>\n";
		print "</div>\n";
		print ' <!--final::Aca estoy -->';
		print "</div>\n";
		print ' <!--final::Aca estoy 2-->';
	...
	<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										...
										<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											<img src="/metronic8/demo1/assets/media/avatars/150-18.jpg" alt="user">
										</div>
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<div class="symbol symbol-50px me-5">
														<img alt="Logo" src="/metronic8/demo1/assets/media/avatars/150-18.jpg">
													</div>
													<!--end::Avatar-->
													<!--begin::Username-->
...
function top_menu_user($hideloginname = 0, $urllogout = '')
{
	...
	if (empty($conf->global->MAIN_OPTIMIZEFORTEXTBROWSER)) {
	    ...
	    <div id="topmenu-login-dropdown" class="userimg coloGris  dropdown user user-menu inline-block">
	        <a href="' . DOL_URL_ROOT . '/user/card.php?id=' . $user->id . '" class="dropdown-toggle login-dropdown-a" data-toggle="dropdown">
	            ' . $userImage . '<span class="hidden-xs maxwidth200 coloGris username hideonsmartphone paddingleft">' . dol_trunc($user->firstname ? $user->firstname : $user->login, 10) . '</span>
	        </a>
...
function left_menu_metronic($menu_array_before, $helppagename = '', $notused = '', $menu_array_after = '', $leftmenuwithoutmainarea = 0, $title = '', $acceptdelayedhtml = 0)
{
	...
	if (empty($conf->dol_hide_leftmenu) && (!defined('NOREQUIREMENU') || !constant('NOREQUIREMENU'))) {
		...
		<div class="aside-menu flex-column-fluid">
		  <!--begin::Aside Menu-->
			<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0" style="height: 439px;">
		';
		print '<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">';
		print '<div data-kt-menu-trigger="click" class="menu-item here menu-accordion">
		...
		print'<div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
